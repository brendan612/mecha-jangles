...
module.exports = {
	...
	async execute(interaction) {
        ...
        if (victim.voice){
            interaction.client.VCM.PlaySound(victim.voice.channel.id, interaction.guild.id, interaction.guild.voiceAdapterCreator, './assets/sounds/funny_sound.mp3', 0, false, async function(){
