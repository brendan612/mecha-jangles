...
module.exports = {
	...
	async execute(interaction) {
        ...
        if (user.voice){
            interaction.client.VCM.PlaySound(user.voice.channel.id, interaction.guild.id, interaction.guild.voiceAdapterCreator, '../bot/assets/sounds/shutup.mp3 ', 0, false, async function(){
