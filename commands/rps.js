	...
	async execute(interaction) {
        ...
        async function beginGame(){
            ...
            collector.on('collect', async i => {
                await i.deferUpdate();
                processInteraction(i, collector)
            });
        }
    
        async function processInteraction(i, collector){
            console.log("here");
            ...
            if (player1Choice && player2Choice){
                ...
                player2Field.value = player2Choice === RPS_OPTIONS.Rock ? RPS_OPTIONS.RockEmoji : player2Choice === RPS_OPTIONS.Paper ? RPS_OPTIONS.PaperEmoji : RPS_OPTIONS.ScissorsEmoji;
                if (player1Choice === player2Choice){
